...
export default function JuryAnnouncements() {
    ...
    useEffect(() => {
        ...
        const unsub = subscribeAnnouncements("jury", (data) => {
                                ...
                                <div className="flex-1">
                                    <div className="flex items-center gap-2 mb-1">
                                        ...
                                        {audienceLabel(a.audience) && (
                                            <Badge className="bg-orange-500/20 text-orange-300 border-orange-500/40 text-xs">{audienceLabel(a.audience)}</Badge>
                                        )}
                                    </div>
